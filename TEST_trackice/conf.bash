...
case ${host} in
    "merlat")
        DATA_DIR="/MEDIA/data"
        NbRec=4
        #HSS=2 ; RESOL0=24 ; MARKER_SIZE=30 ; # NANUK4 with sub-samp of 5 !
        HSS=3 ; RESOL0=36 ; MARKER_SIZE=30 ; # NANUK4 with sub-samp of 5 !
        ;;
    "mcp-oceannext-01")
    ...
    "frazilo")
        DATA_DIR="/data"
        NJPAR=28
        HSS=1 ; RESOL0=12; NbRec=32; MARKER_SIZE=8 ; # NANUK4 no subsampling
