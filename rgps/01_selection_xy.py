...
if __name__ == '__main__':
    ...
    cf_npz_in = './npz/RGPS_stream_selection_'+cdtS1+'_'+cdtS2+'.npz'
    ...
    print('\n *** Opening "selected streams" data into '+cf_npz_in+'!')
    ...
    for jS in range(Nstreams):
        ...
        if lStreamOk:
            ...
            iFU, xmsk, nBpR = mjt.StreamTimeSanityCheck( cs, ztim, VT, xmsk, nBpR, max_t_dev_allowed_in_bin, iverbose=2 )
            #
            del ztim
