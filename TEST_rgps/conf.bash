...
case ${host} in
    ...
    "frazilo")
        ...
        #
        # 640km:
        DT_BINS_H=$((24*3)) ; RESKM=640 ; LIST_RD_SS="570 580 590 600 605  610 613 615 617 620 623 625 627 630 632 633 635 640 645 650 655 660 665 670 675 680 685 690 700 710 720"
        #DT_BINS_H=$((24*3)) ; RESKM=640 ; LIST_RD_SS="590 600 610 615 620 625 630 635 640 645 650 655 660 670 680"
