...
case ${host} in
    ...
    "frazilo")
        ...
        # 320km:
        DT_BINS_H=$((24*3)) ;  RESKM=320; LIST_RD_SS="220 230 240 260 270 280 285 290 295 300 305 310 315 320 325 330 335 340 350 360"
        # 640km:
        #T_BINS_H=$((24*3)) ;  RESKM=640; LIST_RD_SS="550 560 570 580 590 600 610 615 620 625 630 635 640 645 650 660 670 680 690"
        #
        ;;
    *)
