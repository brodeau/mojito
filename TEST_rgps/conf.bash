...
case ${host} in
    ...
    "frazilo")
        ...
        #
        # 640km:
        #DT_BINS_H=$((24*3)) ; RESKM=640 ; LIST_RD_SS="550 560 570 580 590 600 605 610 615 620 625 630 633 635 637 640 645 650 655 660 665 670 675 680 685 690 700 710 720 730"
        #
        ...
        DT_BINS_H=$((24*3)) ; RESKM=640 ; LIST_RD_SS="550 560 570 580 590 600 610 620 625 630 633 635 637 640 645 650 660 670 680 690 700" ; #
        #
        ;;        
    "merlat")
        NJPAR=5
