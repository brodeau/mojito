...
case ${host} in
    ...
    "frazilo")
        ...
        #
        # So far best is with: frac_overlap=0.05 and rc_t_dev_cancel =  12*3600        :
        #DT_BINS_H=72 ;  RESKM=320; LIST_RD_SS="265 270 275 285 290 295 300 305 310  315  320 325 330 335 340 345 355 360 365 370"
        #
        DT_BINS_H=72 ;  RESKM=320; LIST_RD_SS="265 270 275 280 285 290 295 300 305 310 313  315  317 320 325 330 335 340 345 350 355 360 365 370"
        #
        # 640km:
        #DT_BINS_H=$((24*3)) ; RESKM=640 ; LIST_RD_SS="570 580 590 600 610 615 620 625 630 633 635 637 640 645 650 655 660     670 680 690 700"
        #DT_BINS_H=$((24*3)) ; RESKM=640 ; LIST_RD_SS="560 570 580 590 600 610 615 620 625 630 633 635 637 640 645 650 655 660     670 680 690 700 710 720"
        #
        ;;        
    "merlat")
        NJPAR=4
